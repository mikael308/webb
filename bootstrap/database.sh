...
;;
	"drop")
sudo su postgres <<SHELL
psql -U postgres -d postgres -f /vagrant/bootstrap/database/drop_database.sql
SHELL
;;
	"reset")
...
;;
    ...
    "tables:clear") 
sudo su postgres <<SHELL
psql -U postgres -d postgres -f /vagrant/bootstrap/database/clear_tables.sql
SHELL
;;
    "tables:drop")
sudo su postgres <<SHELL
psql -U postgres -d postgres -f /vagrant/bootstrap/database/drop_tables.sql
SHELL
;;  
    "tables:reset")
...
;;
    ...
    "dummy")
php /vagrant/bootstrap/database/dummy.php
;;
